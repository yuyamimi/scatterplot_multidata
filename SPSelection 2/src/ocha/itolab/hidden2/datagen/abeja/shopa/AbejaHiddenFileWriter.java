...
public class AbejaHiddenFileWriter {
	...
	static void writeTopLines() {
		...
		println("Explain,Explain,Explain,Explain,Explain,Explain,Explain,Objective,Objective,Objective,Objective,Objective,Objective,Objective,Category,Category,Name");
		println("MinTemp,MaxTemp,SumRain,SumSnow,SumSnowC,SumSunTime,MaxWind,Revenue,Guest1,Guest2,Ratio,PerGuest,AveUnit,AveNum,Holiday,BadWeather,Date");
	}
